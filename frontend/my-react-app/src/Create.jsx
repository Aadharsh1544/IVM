...
// const CreateModal = ({ isOpen, onRequestClose,fetchData }) => {
...
//       // Clear editableData when the modal is opened
//       setEditableData({});
//     }
//   }, [isOpen]);
...
//       try {
//         // Create new data
//         const response = await axios.post('http://localhost:5000/data', editableData);
//         console.log('Create response:', response.data);
//         alert('Data created successfully');
//         await fetchData();
//         onRequestClose(); // Close the modal after creation
//       } catch (error) {
...
//           <h2 className="text-center mb-4 text-primary">Create New Data</h2>
...
//               <button className="btn btn-primary" onClick={handleShowPasswordPopup}>Create</button>
...
//                   <button className="btn btn-primary" onClick={handleCreateSubmit}>Submit</button>
//                 </div>
//               </div>
//             </div>
//           )}
